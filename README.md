...
**项目状态**：v1.5.2 完成 (2026-05-01) — 入站规则 35 → 69 条（v1.5.1 +22 五件怕事 + v1.5.2 +12 BIP39 inbound second-pass + 边缘形态），测试数据集 296 → 1951 条（含 55 条**已公开发生过的真实攻击复现**：Ledger 2023 / Multichain $126M / Lazarus Op99 / CVE-2025-6514），PRD §9 #7 硬约束实测：**Critical FP 0.00%（0/1070）+ Attack Recall 99.71%（694/696）+ 公开攻击拦截率 92.7%（51/55）**。详见 [CHANGELOG v1.5.2](docs/changelog/CHANGELOG.md#v152-blind-spots-and-public-replay---2026-05-01)。Week 2 起 OUT-01~11 出站规则上线，BIP39 SHA-256 校验，release 二进制 9.0 MB。repo 保持 private 至 Week 12 GA，见 [ADR-011](docs/design/ADR-011-private-until-ga.md)。
