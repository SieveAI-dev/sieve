...
**项目状态**：Week 1 工程启动 (2026-04-27) — Cargo workspace + 透传 daemon + sigstore CI 已就绪，功能性 Anthropic 透传可用，规则匹配 Week 2 起。repo 保持 private 至 Week 12 GA，见 [ADR-011](docs/design/ADR-011-private-until-ga.md)。

- 当前最新 PRD：[sieve-prd-v1.3.md](./docs/prd/sieve-prd-v1.3.md)（已锁定执行）
...
| 入口                                                                       | 用途                                                  |
| ------------------------------------------------------------------------ | --------------------------------------------------- |
| [docs/requirements/PRD-sieve.md](./docs/requirements/PRD-sieve.md)       | 需求文档活动版本入口（指向 PRD v1.3）                             |
...
| [docs/prd/](./docs/prd/)                                                 | PRD 历史归档（v1.0 → v1.3）                               |
...
graph TD
    ...
    PRDv13[docs/prd/sieve-prd-v1.3.md<br/>当前活动 PRD]
