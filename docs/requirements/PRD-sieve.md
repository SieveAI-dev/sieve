...
| 版本       | 日期                       | 主要变化                                                                                  | 文件                                                              |
| -------- | ------------------------ | ------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| v1.0     | 初版                       | 第一性原理推导 + 单 agent 架构 + 12 周里程碑骨架                                                      | [../prd/_archive/sieve-prd-v1.0.md](../prd/_archive/sieve-prd-v1.0.md)            |
| v1.1     | 中间版                      | 检测项 ID 化（OUT-01~12 / IN-CR-* / IN-GEN-*）+ 处置矩阵 + 误报率预算                                | [../prd/_archive/sieve-prd-v1.1.md](../prd/_archive/sieve-prd-v1.1.md)            |
| v1.2     | 第一性原理 + 性能预算定稿版          | 性能预算具体化（P99 < 20ms）+ Rust 技术栈定稿 + 数据飞轮简化版 + 公理 12（FP < 0.5%）                          | [../prd/_archive/sieve-prd-v1.2.md](../prd/_archive/sieve-prd-v1.2.md)            |
| v1.3     | 2026-04-26                 | 8 条 GPT-5.5 review 改动：合规边界 + 自证清白叙事 + MCP Phase 2 + 数据合作清单 + benchmark 具体化 + 闭测画像 | [../prd/_archive/sieve-prd-v1.3.md](../prd/_archive/sieve-prd-v1.3.md) |
| v1.4 | 2026-04-27 | HIPS 弹窗架构 + Native GUI App + setup 自动配置 + Claude Code hooks 双层防御：14 条改动，§9 新增第 11-13 条硬约束 | [../prd/_archive/sieve-prd-v1.4.md](../prd/_archive/sieve-prd-v1.4.md) |
| v1.5 | 2026-04-28 | Multi-Agent 扩展（Claude Code + OpenClaw + Hermes 三家适配）：15 条改动，§9 第 9 条重写，新增 IN-GEN-06 / IN-CR-06 检测项 | [../prd/_archive/sieve-prd-v1.5.md](../prd/_archive/sieve-prd-v1.5.md) |
...
2. **入口与归档分离**：`docs/prd/_archive/sieve-prd-v1.3.md` 是定稿后的快照（不可改），本文件是入口指针（可改），便于版本演进。
