...
> 关联 PRD：[v1.3 §6.3、§9.1](../prd/sieve-prd-v1.3.md)
...
- [PRD-sieve v1.3 §6.3](../prd/sieve-prd-v1.3.md) —— Rust 技术栈表
- [PRD-sieve v1.3 §9.1](../prd/sieve-prd-v1.3.md) —— 工程硬约束第 1 条："Rust 栈非选项"
