...
> 关联 PRD：[v1.5 §4.6 场景 F、§6.5 IPC 协议扩展](../prd/sieve-prd-v1.5.md)
...
PRD v1.5 §4.6 场景 F 描述了一种典型的 multi-agent 嵌套调用路径：
...
- [PRD v1.5 §6.5](../prd/sieve-prd-v1.5.md) — X-Sieve-Origin header 格式定义（已在 PRD 中预占位，本 ADR 提供完整规范）
...
- [PRD v1.5 §4.6 场景 F](../prd/sieve-prd-v1.5.md) — Hermes 嵌套调用问题定义
- [PRD v1.5 §6.5 IPC 协议](../prd/sieve-prd-v1.5.md) — IPC schema 扩展（source_agent / origin_chain 字段）
