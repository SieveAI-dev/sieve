...
> 关联 PRD：[v1.5 §6.1、§6.3、§9 第 9 条](../prd/sieve-prd-v1.5.md)
...
- [PRD v1.5 §6.1 整体架构](../prd/sieve-prd-v1.5.md) — Protocol Layer 重画，openai.rs 节点
- [PRD v1.5 §6.3 Rust 技术栈](../prd/sieve-prd-v1.5.md) — 新增依赖：自写 serde（避免引入 async-openai）
- [PRD v1.5 §9 第 9 条](../prd/sieve-prd-v1.5.md) — 硬约束重写：三家 agent + UnifiedMessage 统一
