...
- PRD v2.0 §6.1 整体架构 — Protocol Layer 重画，openai.rs 节点
- PRD v2.0 §6.3 Rust 技术栈 — 新增依赖：自写 serde（避免引入 async-openai）
- PRD v2.0 §9 第 9 条 — 硬约束重写：三家 agent + UnifiedMessage 统一
