...
v1.4 §10.1 Week 5 里程碑：GUI App 完成 HIPS 弹窗主流程（地址替换 / 签名 / markdown exfil 弹窗，含授权/拒绝/倒计时 3 段视觉）。
...
- doskey 一人维护，monorepo 没有协作同步价值，反而拖慢 Rust 的 clean build 时间；
...
- `tasks/roadmap.md` Week 5 —— GUI App 完成 HIPS 弹窗主流程
