...
> 关联 PRD:[v1.4 §9 #10](../prd/_archive/sieve-prd-v1.5.md) (取代该条 Day 1 公开子条款) / §10.1 Week 1(修订) / §11.3 开源策略(保留)
...
- [x] `docs/prd/_archive/sieve-prd-v1.5.md` §9 #10 + §10.1 Week 1 任务清单
...
- [PRD v1.4 §9 工程硬约束](../prd/_archive/sieve-prd-v1.5.md#9-工程上必须做对的硬约束)
- [PRD v1.4 §11.3 开源策略](../prd/_archive/sieve-prd-v1.5.md#113-开源策略)
