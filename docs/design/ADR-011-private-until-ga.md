...
> 关联 PRD:[v1.3 §9 #10](../prd/sieve-prd-v1.3.md) (取代该条 Day 1 公开子条款) / §10.1 Week 1(修订) / §11.3 开源策略(保留)
...
- [x] `docs/prd/sieve-prd-v1.3.md` §9 #10 + §10.1 Week 1 任务清单
...
- [PRD v1.3 §9 工程硬约束](../prd/sieve-prd-v1.3.md#9-工程上必须做对的硬约束)
- [PRD v1.3 §11.3 开源策略](../prd/sieve-prd-v1.3.md#113-开源策略)
