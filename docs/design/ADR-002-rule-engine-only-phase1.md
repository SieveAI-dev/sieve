...
但 Sieve 是**一人公司**，doskey 一个人 + Claude Code 完成 12 周冲刺，决策面临两个第一性原理硬约束：
...
2. **规则集维护负担**：每周更新规则库（[PRD §8.3](../prd/_archive/sieve-prd-v1.5.md)）需要 doskey 持续投入 5–10 小时；用 Claude Code 辅助 + GitHub issue 公开样本流程缓解；
