...
闭测用户 + dogfood 用户主动将 `sequence_detection = true` 配置开启。GA 营销话术**不承诺**行为序列检测能力，不作为 [redacted]/月 [redacted]必达卖点。
...
- [HIPS Readiness Assessment 2026-05-01](../review/_archive/2026-05-01-hips-readiness-assessment.md) —— v2.0 改造出发点（行为序列为"部分满足"项）
