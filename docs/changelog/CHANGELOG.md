...
- LICENSE：移除 `[redacted]/月` 硬定价表述，改为 Phase 1 全免费 / Phase 2+ 商业路径 TBD，与 [ADR-029](../design/ADR-029-free-first-defer-monetization.md) 和 PRD v2.0 §11 保持一致。
...
- ADR-005 把「[redacted]...」等个人身份表述改为「创始人/境内自然人身份」，避免 ADR 公开后绑定个人信息。
...
- **W5 配置系统 + 试用期 + brew tap**
  ...
  - License 验证 + 试用期机制（**本地 Ed25519 验证，不联网 verify**，[PRD §9 #2](../prd/_archive/sieve-prd-v1.3.md#9-工程上必须做对的硬约束)）
