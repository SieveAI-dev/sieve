...
**v2.0 + v2.1 代码 + SPEC-005 v2 协议改造 + v2.0+ 兼容扩展全部就绪 — 等手动联调**（2026-05-03）。Cargo workspace 6 crate；P0/P1/P2 + 善后全清；e2e 集成测试 6 场景；workspace 696 passed；fmt/clippy/deny 全绿。GUI 仓库同步完成（swift test 127 + xcodebuild SUCCEEDED）。
